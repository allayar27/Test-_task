...
<div class="row g-5">
      <div class="col-md-7 col-lg-8">
        ...
        <form action="{{ route('category.update', $category->id) }}" class="needs-validation" method="POST">
          @csrf
          @method('PATCH')
          <div class="row g-3">
            <div class="col-6">
            ...
            <div class="col-12">
              ...
              <textarea name="description" class="form-control" id="exampleInputEmail1" placeholder="description..">{{ $category->description }}</textarea>
              </div>
            </div>
